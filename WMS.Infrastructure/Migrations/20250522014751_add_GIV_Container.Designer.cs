...
namespace WMS.Infrastructure.Migrations
{
    ...
    [Migration("20250522014751_add_GIV_Container")]
    partial class add_GIV_Container
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WMS.Domain.Models.GIV_Inventory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime>("ActualUnstuffingDate")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTime>("UnstuffingDate")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("WMS.Domain.Models.GIV_Pallet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TB_GIV_Pallet");
                });

            modelBuilder.Entity("WMS.Domain.Models.GIV_Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WMS.Domain.Models.GIV_Inventory", b =>
                {
                    ...
                    b.HasOne("WMS.Domain.Models.GIV_Pallet", "Pallet")
                        .WithMany("Inventories")
                        .HasForeignKey("PalletId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WMS.Domain.Models.GIV_Product", "Product")
                        .WithMany("Inventories")
            ...
            modelBuilder.Entity("WMS.Domain.Models.GIV_InventoryMovement", b =>
                {
                    ...
                    b.HasOne("WMS.Domain.Models.GIV_Inventory", "Inventory")
                        .WithMany("Movements")
