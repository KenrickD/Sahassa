...
namespace WMS.Infrastructure.Migrations
{
    ...
    [Migration("20250523101738_addPhotoTable2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WMS.Domain.Models.GIV_FGInventory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TB_GIV_FGInventory");
                });

            modelBuilder.Entity("WMS.Domain.Models.GIV_FG_ReceiveItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TB_GIV_FG_ReceiveItem");
                });

            modelBuilder.Entity("WMS.Domain.Models.GIV_FG_ReceiveItemPhoto", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TB_GIV_FG_ReceiveItemPhoto");
                });
            ...
            modelBuilder.Entity("WMS.Domain.Models.GIV_RM_ReceiveItemBreakdown", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("GIV_FG_ReceiveItemId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("GIV_FG_ReceiveItemId");

                    b.HasIndex("WarehouseId");

                    b.ToTable("TB_GIV_RM_ReceiveItemBreakdown");
                });
            ...
            modelBuilder.Entity("WMS.Domain.Models.GIV_RM_ReceiveItemBreakdown", b =>
                {
                    b.HasOne("WMS.Domain.Models.GIV_FG_ReceiveItem", "GIV_FG_ReceiveItem")
                        .WithMany()
                        .HasForeignKey("GIV_FG_ReceiveItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("GIV_FG_ReceiveItem");
