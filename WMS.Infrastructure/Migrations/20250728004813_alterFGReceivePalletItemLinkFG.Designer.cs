...
namespace WMS.Infrastructure.Migrations
{
    ...
    [Migration("20250728004813_alterFGReceivePalletItemLinkFG")]
    partial class alterFGReceivePalletItemLinkFG
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WMS.Domain.Models.GIV_Container", b =>
                {
                    ...
                    b.Property<bool>("IsSamplingArrAtWarehouse")
                        .HasColumnType("boolean");
                    ...
                    b.Property<DateTime?>("StuffEndTime")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("StuffStartTime")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("StuffedBy")
                        .HasColumnType("text");

                    b.Property<DateTime?>("StuffedDate")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("WMS.Domain.Models.GIV_FG_Release", b =>
                {
                    ...
                    b.Property<string>("ActualReleasedBy")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("WMS.Domain.Models.GIV_FG_ReleaseDetails", b =>
                {
                    ...
                    b.Property<Guid?>("GIV_FG_ReceiveId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("GIV_FG_ReceivePalletId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("GIV_FG_ReceivePalletItemId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("IsEntirePallet")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("GIV_FG_ReceiveId");

                    b.HasIndex("GIV_FG_ReceivePalletId");

                    b.HasIndex("GIV_FG_ReceivePalletItemId");
            ...
            modelBuilder.Entity("WMS.Domain.Models.GIV_FG_ReleaseDetails", b =>
                {
                    b.HasOne("WMS.Domain.Models.GIV_FG_Receive", "GIV_FG_Receive")
                        .WithMany()
                        .HasForeignKey("GIV_FG_ReceiveId");
                    ...
                    b.HasOne("WMS.Domain.Models.GIV_FG_ReceivePalletItem", "GIV_FG_ReceivePalletItem")
                        .WithMany()
                        .HasForeignKey("GIV_FG_ReceivePalletItemId");
                    ...
                    b.Navigation("GIV_FG_Receive");

                    b.Navigation("GIV_FG_ReceivePallet");

                    b.Navigation("GIV_FG_ReceivePalletItem");
